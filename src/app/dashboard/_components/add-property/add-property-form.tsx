  ...
  return (
    <Form {...form}>
      <form
        ...
        className="relative flex h-full flex-grow flex-col gap-6 overflow-y-scroll pb-[100px] sm:pb-0 "
      >
        <div className="flex flex-grow flex-col space-y-4 px-2 sm:px-4">
          ...
          <div className="flex flex-col justify-between gap-1 sm:flex-row sm:gap-6 md:flex-nowrap">
            <FormField
              control={form.control}
              name="tehsil"
              render={({ field }) => (
          ...
          <FormField
            ...
            name="brokerEntityId"
            render={({ field }) => (
              <FormItem className="flex flex-col gap-2 sm:basis-1/2">
        ...
        <div className="fixed bottom-0 flex w-full items-center justify-center gap-2 border-t bg-white pb-6 pt-6 sm:border-t-0">
